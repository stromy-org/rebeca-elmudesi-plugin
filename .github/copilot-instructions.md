...
rebeca-elmudesi is a Claude Code plugin for Rebeca Elmudesi. It is a **distribution artifact** — skills are authored in Workspace Studio and cherry-picked here for client deployment.
...
├── companies/rebecaelmudesi/  # Brand data (charter, logos, colors)
...
This plugin defaults to **Rebeca Elmudesi** brand data at `companies/rebecaelmudesi/`. Skills read `charter.json`, `logos/`, `images/`, and `tokens.css` from this path automatically — no prompt-time client selection needed.

For collaborative brands (e.g., "Rebeca Elmudesi x Partner"), skills fall back to the Rebeca Elmudesi charter for any missing fields.

**Slug discipline (`client_slug` is `rebecaelmudesi`):**
...
- Default brand: `companies/rebecaelmudesi/` — hardwired, no discovery needed
